  ...
  return (
    <>
      <div className="flex flex-col w-full h-full">
        <div className="max-w-full  bg-gray-600 ">
          ...
          <div className="flex flex-col  ">
            <div className="flex items-center justify-end ">
              ...
              <button
                ...
                className="bg-green-500 mt-2 mr-2 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded ml-2"
              >
                Search
              </button>
            </div>
            <div className="flex flex-col">
              <h2 className="text-3xl font-medium px-4 sticky text-white">
                {detail}
              </h2>
