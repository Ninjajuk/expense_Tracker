...
const awesomeBackgroundColors = ["bg-gray-300", "bg-red-700", "bg-green-500"];
    ...
    <Layout3>
      ...
      >
        ...
        <div className="h-full w-full flex flex-col md:flex-row md:px-12 py-4  gap-2 ">
          {/* Left column */}
          <div className="w-full   md:w-3/5 flex flex-col gap-2 bg-pink-300 md:pr-2 rounded-md shadow-md">
            ...
            {/* Table Starts here */}
            <div className=" flex-grow   my-2 py-2 rounded-md  ">
              <div className="flex  flex-col w-full h-full   ">
                <div className="flex flex-grow flex-col md:flex-row px-2 gap-2 ">
                  <div className="w-full md:w-1/2   bg-green-400 rounded-md shadow-md">
                    <DoughnutChart />
                  </div>
          ...
          <div className="md:w-2/5 px-2 flex flex-col bg-indigo-500 md:pl-2 rounded-md shadow-md">
            ...
            <div className="flex-grow p-2 mb-2 ">
              {/* transactions  */}
              <div className="h-full bg-yellow-600 rounded-md shadow-md p-2 overflow-y-auto hover:bg-yellow-800 transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
